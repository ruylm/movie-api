...
public class MovieController {
	...
	public MovieController(CreateMovieInterector createMovieInterector, GetMovieListInterector getMovieListInterector, 
			GetMovieByIdInterector getMovieByIdInterector, RemoveMovieInterector removeMovieInterector, MovieDTOMapper movieDTOMappe) {
	...
	public ResponseEntity<List<GetMovieResponse>> getMovieList() {
		...
		//return movieDTOMapper.toResponseList(movieList);
	...
	public ResponseEntity<GetMovieResponse> getMovieById(@PathVariable("id") Long id) {
		...
		//return movieDTOMapper.toGetMovieResponse(movie);
...
//	@PutMapping("/{id}")
//	@ResponseStatus(HttpStatus.NO_CONTENT)
//	public Class<Void> updateMovie(@RequestBody CreateMovieRequest request) {
//		Movie movieList = createMovieInterector.getMovieById(id);
//		if(movieList == null) {
//			new ResponseStatusException(HttpStatus.NOT_FOUND);
//		}
//		createMovieInterector.removeMovie(id);
//		return Void.TYPE;
//	}
}
